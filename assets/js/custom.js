...
document.addEventListener('DOMContentLoaded', function () {
    // Upload prescription via WhatsApp (user attaches file after WhatsApp opens)
    var uploadBtn = document.getElementById('prescription-upload-btn');
    var uploadInput = document.getElementById('prescription-upload');
    if (uploadBtn && uploadInput) {
        ...
        uploadInput.addEventListener('change', function () {
            ...
            var phone = '254743052401';
            var text = 'Hello Chiron Mediplus, I am sending a prescription. Please find the photo attached.';
    ...
    if (!document.querySelector('.whatsapp-float')) {
        ...
        wa.href = 'https://wa.me/254743052401';
        wa.target = '_blank';
        wa.rel = 'noopener';
        wa.setAttribute('aria-label', 'Chat on WhatsApp');
        wa.innerHTML = "<i class='bx bxl-whatsapp'></i>";
